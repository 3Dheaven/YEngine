...
std::map<VkResult, std::string> CVulkanException::m_statuses;

CVulkanException::CVulkanException(const VkResult status, const std::string& msg)
...
CVulkanException::~CVulkanException()
{
}

const std::string CVulkanException::GetStatus() const
{
